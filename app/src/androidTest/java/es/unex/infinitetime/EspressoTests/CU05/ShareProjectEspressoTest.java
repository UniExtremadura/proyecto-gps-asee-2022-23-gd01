package es.unex.infinitetime.EspressoTests.CU05;
...
public class ShareProjectEspressoTest {
    ...
    @Test
    public void compartirProyectoTest2() {
        ...
        ViewInteraction textInputEditText = onView(
                allOf(withId(R.id.textEdit_username_register),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText.perform(replaceText("CU05a"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText2 = onView(
                allOf(withId(R.id.textEdit_email_register),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText2.perform(replaceText("CU05a@unex.es"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText4 = onView(
                allOf(withId(R.id.textEdit_username_register),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText4.perform(replaceText("CU05b"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText5 = onView(
                allOf(withId(R.id.textEdit_email_register),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText5.perform(replaceText("CU05b@unex.es"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.ProjectNameEdit),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Proyecto CU05"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText7 = onView(
                allOf(withId(R.id.textEdit_username_login),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText7.perform(replaceText("CU05a"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.tv_item_project_name), withText("Proyecto CU05"),
                        withParent(withParent(withId(R.id.recyclerView))),
                        isDisplayed()));
        textView.check(matches(withText("Proyecto CU05")));
        ...
        ViewInteraction textInputEditText9 = onView(
                allOf(withId(R.id.textEdit_username_login),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText9.perform(replaceText("CU05b"), closeSoftKeyboard());
