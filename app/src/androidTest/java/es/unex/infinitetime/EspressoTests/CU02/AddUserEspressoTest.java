package es.unex.infinitetime.EspressoTests.CU02;
...
public class AddUserEspressoTest {
    ...
    public void crearUsuarioTest() {
        ...
        ViewInteraction textInputEditText2 = onView(
                allOf(withId(R.id.textEdit_username_register),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText2.perform(replaceText("CU02"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText3 = onView(
                allOf(withId(R.id.textEdit_email_register),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText3.perform(replaceText("CU02@unex.es"), closeSoftKeyboard());
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.textEdit_username_login), withText("CU02"),
                        withParent(withParent(withId(R.id.txt_username_login))),
                        isDisplayed()));
        editText.check(matches(withText("CU02")));

        ViewInteraction editText2 = onView(
                allOf(withId(R.id.textEdit_password_login), withText("12345"),
                        withParent(withParent(withId(R.id.txt_password_login))),
                        isDisplayed()));
